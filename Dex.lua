			...
			for _,node in next, sList do
				...
				if Obj:IsA("BasePart") then
					if Obj.CanCollide then
						...
						plrRP.CFrame = CFrame.new(Obj.Position + (Settings and Settings.Explorer and Settings.Explorer.TeleportToOffset or Vector3.new(0, 3, 0)))
					end
					break
				elseif Obj:IsA("Model") then
					if Obj.PrimaryPart then
						if Obj.PrimaryPart.CanCollide then
							...
							plrRP.CFrame = CFrame.new(Obj.PrimaryPart.Position + (Settings and Settings.Explorer and Settings.Explorer.TeleportToOffset or Vector3.new(0, 3, 0)))
						end
						break
					else
						...
						if part and nodes[part] then
							if part.CanCollide then
								...
								plrRP.CFrame = CFrame.new(part.Position + (Settings and Settings.Explorer and Settings.Explorer.TeleportToOffset or Vector3.new(0, 3, 0)))
							end
							break
